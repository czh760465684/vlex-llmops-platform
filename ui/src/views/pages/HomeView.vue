...
const opening_questions = ['什么是VlexAI平台?', '我想创建一个AI应用', '能介绍下什么是RAG吗?']
      ...
      >
        <div class="mb-9">
          ...
          <div class="text-base text-gray-700">
            说出你的创意，我可以快速帮你创建专属应用，一键轻松分享给朋友，也可以一键发布到Vlex
            LLMOps 平台、微信等多个渠道。
          </div>
        </div>
        <!-- 开场AI对话消息 -->
        <div class="flex gap-2">
          ...
          <div class="flex flex-col items-start gap-2">
            ...
            >
              <div class="font-bold">你好，欢迎来到VlexLLMOps🎉</div>
              <div class="">
                VlexLLMOps是新一代大模型 AI 应用开发平台。无论你是否有编程基础，都可以快速搭建出各种
              ...
              <ul class="list-disc pl-6">
                ...
                <li>你也可以向我提问有关平台操作的问题，我可以快速替你解答。</li>
              </ul>
              <div class="">如果你还有其他VlexLLMOps使用问题，也欢迎随时问我！</div>
            </div>
            <!-- 开场白建议问题 -->
